...
var INGREDIENTS = [
  ...
  },
  {
    ...
    originPlace: "Uttar Pradesh & Himachal",
    displayOrder: 2,
  ...
  },
  {
    id: 3,
    name: "Castor Oil",
    sanskritName: "Ricinus Communis",
    emoji: "\u{1F330}",
    imageSlug: "castor-oil",
    tag: "Root Strengthening",
  ...
  },
  {
    id: 4,
    name: "Coconut Oil",
    sanskritName: "Cocos Nucifera",
    emoji: "\u{1F965}",
    imageSlug: "coconut-oil",
    tag: "Deep Moisture",
  ...
  },
  {
    ...
    originPlace: "Maharashtra & Madhya Pradesh",
    displayOrder: 5,
  ...
  },
  {
    id: 6,
    name: "Hibiscus",
    sanskritName: "Hibiscus Rosa-sinensis",
    emoji: "\u{1F33A}",
    imageSlug: "hibiscus",
    tag: "Shine & Softness",
  ...
  },
  {
    id: 8,
    name: "Rosemary",
    sanskritName: "Salvia Rosmarinus",
    emoji: "\u{1F33F}",
    imageSlug: "rosemary",
    tag: "Growth Activator",
    ...
    originPlace: "Nilgiris, Tamil Nadu",
    displayOrder: 8,
  ...
  },
  {
    id: 9,
    name: "Curry Leaves",
    sanskritName: "Murraya Koenigii",
    emoji: "\u{1F343}",
    imageSlug: "curry-leaves",
    tag: "Anti-Greying",
    ...
    originPlace: "Karnataka & Andhra Pradesh",
    displayOrder: 9,
  ...
  },
  {
    id: 11,
    name: "Aloe Vera",
    sanskritName: "Aloe Barbadensis",
    emoji: "\u{1F335}",
    imageSlug: "aloe-vera",
    tag: "Moisture Sealing",
  ...
  },
  {
    id: 12,
    name: "Nigella Seeds",
    sanskritName: "Nigella Sativa",
    emoji: "\u{1F5A4}",
    imageSlug: "nigella-seeds",
    tag: "Scalp Healing",
...
var IngredientService = class _IngredientService {
  ...
  static {
    this.\u0275fac = function IngredientService_Factory(t) {
      return new (t || _IngredientService)();
    };
  }
  static {
...
//# sourceMappingURL=chunk-SSIHF7VO.js.map
