...
function QuizComponent_div_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function QuizComponent_div_15_Template_button_click_21_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.tryNext());
    });
    \u0275\u0275text(22, " Begin the Quiz\n");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function QuizComponent_div_16_button_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, QuizComponent_div_16_button_8_span_5_Template, 2, 0, "span", 47);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function QuizComponent_div_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(2, QuizComponent_div_16_div_2_Template, 2, 1, "div", 35);
    ...
    \u0275\u0275template(8, QuizComponent_div_16_button_8_Template, 6, 5, "button", 37);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(14);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(15, "svg", 41);
    \u0275\u0275element(16, "path", 42);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function QuizComponent_div_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 55)(1, "div", 56)(2, "div", 22);
    \u0275\u0275text(3, "\u26A0\uFE0F");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "h2", 23);
...
function QuizComponent_div_19_div_14_div_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ing_r9);
  }
}
function QuizComponent_div_19_div_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 74)(1, "h3");
    \u0275\u0275text(2, "Key Ingredients For You");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 75);
    \u0275\u0275template(4, QuizComponent_div_19_div_14_div_4_Template, 5, 1, "div", 76);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngForOf", ctx_r1.result.keyIngredients);
  }
}
function QuizComponent_div_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "h2", 61);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p", 62);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 63)(9, "div", 64)(10, "h3");
    \u0275\u0275text(11, "Why This Formula?");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "p");
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(14, QuizComponent_div_19_div_14_Template, 5, 1, "div", 65);
    \u0275\u0275elementStart(15, "div", 66)(16, "div", 67);
    \u0275\u0275text(17, "\u{1F4A1}");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(22);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(23, "div", 68)(24, "p", 69);
    \u0275\u0275text(25, "Interested in ordering? Tap below to chat with us on WhatsApp.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "a", 70);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(27, "svg", 71);
    \u0275\u0275element(28, "path", 72);
    \u0275\u0275elementEnd();
    \u0275\u0275text(29, " Order Vedrithm on WhatsApp ");
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(30, "button", 73);
    \u0275\u0275listener("click", function QuizComponent_div_19_Template_button_click_30_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.reset());
    });
    \u0275\u0275text(31, "Retake Quiz");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.result.keyIngredients == null ? null : ctx_r1.result.keyIngredients.length);
    \u0275\u0275advance(8);
...
var QuizComponent = class _QuizComponent {
  ...
  submitQuiz() {
    ...
    this.http.post("https://vedrithm-backend-1.onrender.com/api/quiz/recommend", payload).subscribe({
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _QuizComponent, selectors: [["app-quiz"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 20, vars: 6, consts: [[1, "quiz-hero"], [1, "quiz-hero-bg"], [1, "container"], [1, "section-tag"], [1, "page-title"], [1, "page-subtitle"], [1, "quiz-section"], [1, "quiz-wrapper"], ["class", "step-indicators", 4, "ngIf"], ["class", "quiz-step", 4, "ngIf"], ["class", "quiz-step loading-step", 4, "ngIf"], ["class", "quiz-step error-step", 4, "ngIf"], ["class", "quiz-result", 4, "ngIf"], [1, "step-indicators"], [1, "step-track"], [1, "step-fill"], [1, "step-dots"], ["class", "step-dot", 3, "done", "active", 4, "ngFor", "ngForOf"], [1, "step-label"], [1, "step-dot"], [1, "quiz-step"], [1, "step-content", "name-step"], [1, "step-icon"], [1, "step-question"], [1, "step-subtitle"], [1, "name-fields"], [1, "field-group"], ["type", "text", "placeholder", "e.g. Priya Sharma", 1, "name-input", 3, "ngModelChange", "keyup.enter", "ngModel"], [1, "phone-input-wrap"], [1, "phone-prefix"], ["type", "tel", "placeholder", "10-digit mobile number", "maxlength", "10", 1, "name-input", "phone-input", 3, "ngModelChange", "keyup.enter", "ngModel"], ["class", "field-hint", 4, "ngIf"], [1, "btn-primary", 3, "click", "disabled"], [1, "field-hint"], [1, "step-content"], ["class", "step-greeting", 4, "ngIf"], [1, "options-grid"], ["class", "option-btn", 3, "selected", "click", 4, "ngFor", "ngForOf"], [1, "step-nav"], [1, "btn-outline", 3, "click"], [2, "flex", "1"], ["width", "16", "viewBox", "0 0 16 16", "fill", "none"], ["d", "M3 8h10M9 4l4 4-4 4", "stroke", "currentColor", "stroke-width", "1.5", "stroke-linecap", "round"], [1, "step-greeting"], [1, "option-btn", 3, "click"], [1, "opt-emoji"], [1, "opt-label"], ["class", "opt-check", 4, "ngIf"], [1, "opt-check"], [1, "quiz-step", "loading-step"], [1, "loading-inner"], [1, "loading-leaves"], [1, "ll"], [1, "loading-text"], [1, "loading-dots"], [1, "quiz-step", "error-step"], [1, "step-content", 2, "text-align", "center"], [1, "btn-primary", 3, "click"], [1, "quiz-result"], [1, "result-header"], [1, "result-eyebrow"], [1, "result-title"], [1, "result-tagline"], [1, "result-body"], [1, "result-rec"], ["class", "result-ingredients", 4, "ngIf"], [1, "result-usage"], [1, "usage-icon"], [1, "result-cta"], [1, "cta-intro"], ["target", "_blank", 1, "whatsapp-order-btn", 3, "href"], ["viewBox", "0 0 24 24", "fill", "white", "width", "22"], ["d", "M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"], [1, "btn-outline", "reset-btn", 3, "click"], [1, "result-ingredients"], [1, "result-ingr-list"], ["class", "result-ingr", 4, "ngFor", "ngForOf"], [1, "result-ingr"], [1, "ingr-dot"]], template: function QuizComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(14, QuizComponent_div_14_Template, 7, 5, "div", 8)(15, QuizComponent_div_15_Template, 23, 4, "div", 9)(16, QuizComponent_div_16_Template, 17, 6, "div", 9)(17, QuizComponent_div_17_Template, 15, 0, "div", 10)(18, QuizComponent_div_18_Template, 10, 1, "div", 11)(19, QuizComponent_div_19_Template, 32, 6, "div", 12);
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(14);
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-7QU27PGE.js.map
